...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name && $email && $message) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'needforcardetailing@gmail.com'; // Vervang met jouw Gmail-adres
            $mail->Password = 'oegtlrwnramtwhzt'; // Vervang met jouw Gmail-wachtwoord of app-wachtwoord
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;

            // Afzender en ontvanger
            $mail->setFrom('needforcardetailing@gmail.com', 'NFCD'); // Gebruik hetzelfde adres als de SMTP-gebruiker
            $mail->addAddress('needforcardetailing@gmail.com', 'NFCD'); // Doeladres
            ...
            echo "<script>alert('Bericht succesvol verzonden!'); window.location.href = 'contact.php';</script>";
        } catch (Exception $e) {
